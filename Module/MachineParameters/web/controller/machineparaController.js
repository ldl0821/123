    ...
    $.post('/diagnosis/r/GetMachinePara', data, (result) => {
        if (result.Status == 0) {
            let P_INT1 = {},
                ...
                P_INT3 = {},
                P_INT4 = {};
            P_INT1.name = lang.ProcessParameters.P_INT1;
            P_INT1.data = [];
            P_INT2.name = lang.ProcessParameters.P_INT3;
            P_INT2.data = [];
            P_INT3.name = lang.ProcessParameters.P_INT5;
            P_INT3.data = [];
            P_INT4.name = lang.ProcessParameters.P_INT4;
            P_INT4.data = [];
            ...
            series3.push(P_INT3);
            series4.push(P_INT4);
            drawline('#P_INT1', lang.ProcessParameters.P_INT1, series1);
            drawline('#P_INT2', lang.ProcessParameters.P_INT3, series2);
            drawline('#P_INT3', lang.ProcessParameters.P_INT5, series3);
            drawline('#P_INT4', lang.ProcessParameters.P_INT4, series4);
        }
    })
}
