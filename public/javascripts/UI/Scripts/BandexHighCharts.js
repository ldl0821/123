            ...
            $(document).mouseup(function(event) {
                ...
                try {
                    if (!event.target.raphael) {
                        if (event.target.nodeName == "svg") {} else {
                    ...
                    if (this.options.url != null) {
                        ...
                        st.mouseover(function() {
                            ...
                            ajaxGet = $.post(this.data("Url"), { StatusID: this.data("StatusID") }, function(data) {
                                //console.log(data)
                                if (data.Data.END == data.Data.START) {
                                    return false;
                                }
                                var message = ' <form class="form-horizontal" style="min-width: 260px;padding-top:0px;">' +
                                    '<div class="control-group" style="margin-bottom: 0px;">' +
                                    '<label class="control-label callout-control-label">' + lang.MachineStatus.StateName + '</label>' +
                                    '<div class="controls controls-control-label">' +
                                    '<span>' + data.Data.NAME + '</span>' +
                                    '</div>' +
                                    '</div>' +
                                    '<div class="control-group" style="margin-bottom: 0px;">' +
                                    '<label class="control-label callout-control-label">' + lang.MachineStatus.startTime + '</label>' +
                                    '<div class="controls controls-control-label">' +
                                    '<span>' + moment(data.Data.START).format("YYYY-MM-DD HH:mm:ss") + '</span>' +
                                    '</div>' +
                                    '</div>' +
                                    '<div class="control-group" style="margin-bottom: 0px;">' +
                                    '<label class="control-label callout-control-label">' + lang.MachineStatus.endTime + '</label>' +
                                    '<div class="controls controls-control-label">' +
                                    '<span>' + moment(data.Data.END).format("YYYY-MM-DD HH:mm:ss") + '</span>' +
                                    '</div>' +
                                    '</div>' +
                                    '<div class="control-group" style="margin-bottom: 0px;">' +
                                    '<label class="control-label callout-control-label">' + lang.MachineStatus.operator + '</label>' +
                                    '<div class="controls controls-control-label">' +
                                    '<span>' + data.Data.MEM + '</span>' +
                                    '</div>' +
                                    '</div>' +
                                    '<div class="control-group" style="margin-bottom: 0px;">' +
                                    '<label class="control-label callout-control-label">' + lang.MachineStatus.stateDescription + '</label>' +
                                    '<div class="controls controls-control-label">' +
                            ...
                            $("#popover").myeditable({
                                title: lang.Quality.Edit + '<i id="BzEditerCancel" style="position: absolute; right: 10px;" class="icon-remove"></i>',
